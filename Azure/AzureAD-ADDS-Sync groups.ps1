...
# Date    : 01/01/2020
# Purpose : Script which syncronize members of AD DS secutiry groups to Azure\Office 365 groups
# Version : 1.0.0.0
# Details : Script which syncronize members of AD DS secutiry groups to Azure\Office 365 groups
# Notes   : 
